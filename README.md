Projeyi tasarlarken katman yapısını asp.net boilerplate frameworkü referans aldım. projeyi 6 katman halinde tasarladım.sigorta sektöründe çalıştığım için ana firma ve bağlı acenteler şekinde planladım.
